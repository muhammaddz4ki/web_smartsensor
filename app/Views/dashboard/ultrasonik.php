...
<head>
    ...
    <title>Dashboard Monitoring Sensor Ultrasonik</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <h3>Admin Panel</h3>
            <p>Monitoring Sensor Ultrasonik</p>
        </div>
    ...
    <div class="main-content" id="main-content">
        ...
        <div class="container">
            <div class="dashboard-grid">
                <div class="card">
                    <h2>Grafik Jarak (cm) vs Waktu</h2>
                ...
                <div class="card">
                    ...
                    <div>
                        <p><strong>Jarak Terakhir:</strong> <span id="last-distance">-</span> cm</p>
    ...
    <script>
        ...
        function init() {
            ...
            database.ref("sensor_data").orderByChild("timestamp").limitToLast(20).on("value", (snapshot) => {
                ...
                if (data) {
                    // Filter data untuk node_id 4 dan urutkan berdasarkan timestamp
                    const rows = Object.entries(data)
                        .filter(([key, value]) => value.node_id === 4)
                    ...
                    rows.forEach(([key, value]) => {
                        ...
                        chartData.push(value.distance_cm);
                        
                        // Simpan data terbaru untuk tampilan status
                        lastDistanceElement.textContent = value.distance_cm;
                    ...
                    // Update chart
                    distanceChart.data.labels = chartLabels;
                    distanceChart.data.datasets[0].data = chartData;
