...
<head>
    ...
    <title>Dashboard Monitoring Sensor LDR</title>
...
<a href="<?= url_to('App\Controllers\Monitoring::allsensor') ?>">
    ...
    <div class="main-content" id="main-content">
        ...
        <div class="container">
            <div class="dashboard-grid">
                <div class="card">
                    <h2>Grafik Intensitas Cahaya vs Waktu</h2>
                ...
                <div class="card">
                    ...
                    <div>
                        <p><strong>Intensitas Cahaya Terakhir:</strong> <span id="last-light">-</span></p>
    ...
    <script>
        ...
        const lastLightElement = document.getElementById("last-light");
                        ...
                        tooltip: {
                            callbacks: {
                                label: function(context) {
                                    return `Intensitas: ${context.parsed.y}`;
                                }
                            }
                        }
                    }
            ...
            database.ref("sensor_data").orderByChild("timestamp").limitToLast(20).on("value", (snapshot) => {
                ...
                if (data) {
                    ...
                    const rows = Object.entries(data)
                        .filter(([key, value]) => value.node_id === 4) // Sesuaikan dengan node_id LDR Anda
                    ...
                    rows.forEach(([key, value]) => {
                        ...
                        const lightValue = value.ldr_value || value.light_intensity || 0; // Sesuaikan dengan field LDR di Firebase
                        ...
                        chartData.push(lightValue);
                        
                        // Simpan data terbaru untuk tampilan status
                        lastLightElement.textContent = lightValue;
                    ...
                    lightChart.data.datasets[0].data = chartData;
                    lightChart.update();
